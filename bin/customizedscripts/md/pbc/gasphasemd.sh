...
gasminimization.sh ${here} ${filename} ${padding} $neutral $2 $3 $4

# equilibration
gasequilibration.sh ${here} ${filename} ${padding} $neutral $2 $3 $4

# production dynamics
gasdynamics.sh ${here} ${filename} ${padding} $neutral  $2 $3 $4
...
#sbatch ${here}/${mddir}/${outputname}_eq.q
    ...
    echo "gasphasemd.sh filename box-x box-y box-z"
fi
